...
function *demoIndexData(oridata){
    ...
    if(mtd === 'POST'){
        ...
        var postdata = {
          ...
          "content": [
            {
              "carseries": body.carTypes
            }
          ]
        }
        var querycartypeData = yield api.pullApiData('querycartype', postdata, 'post')
        console.log(querycartypeData[1]);
        return querycartypeData[1];
    }
