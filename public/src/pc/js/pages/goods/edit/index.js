...
//         var updown  = $(this).parents(".goods_updown");
//         removePicture(updown, updown.attr("data-id"));
//     });
...
//             $('#stopMinute').val(${spGoods.stopMinute});
//             stopMinuteInit = true;
//         }
//     });
//     $(dayStopHours).each(function(index, item){
...
//     var iframe = false;
//     var dataType = "json";
//     var url = "${rc.contextPath}/goods/${spGoods.id}/picture/upload.html";
...
//          updown  = $(this).parents(".goods_updown");
//         removePicture(updown, updown.attr("data-id"));
...
//         $.ajax({
//             type: "GET",
//             url: "${rc.contextPath}/goods/${spGoods.id}/picture/delete/" + id + ".html",
//             timeout: ajaxTimeout,
//             dataType: dataType,
//             async: ajaxAsync,
//             success: function(response) {
//                 obj.removeClass("exist_img").find(".goods_upic").attr("src","").css("visibility","hidden").end().find(".pic_src").attr("name","").val("");
//             },
//             error: function() {
//                 messager.alert({title:"错误提示",content:"删除失败！",type:"error"});
//             }
//         });
