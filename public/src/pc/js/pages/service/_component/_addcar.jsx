...
function dealWith_Data_Brand(){
    ...
    api.req('queryallbrand',{}, function(data){
        ...
        //   console.log(data);
            ...
            rtnDom = <div className="list-wrap" data-reactid=".1.0.0">
                        <ul data-group="group-56091636512428524071081045549363" className="hlist car_linkage" ><li data-idf="0" data-id="" data-cls="" className="item wid-12"><div className="inner"><div className="hbody" ><p data-pid="0" >A</p></div><div className="hfoot" d><p data-pid="0" data-src="select" data-value="奥迪" >奥迪</p><p data-pid="1" data-src="select" data-value="阿尔法·罗米欧">阿尔法·罗米欧</p><p data-pid="2" data-src="select" data-value="阿斯顿·马丁">阿斯顿·马丁</p><p data-pid="3" data-src="select" data-value="AC Schnitzer" >AC Schnitzer</p></div></div></li></ul>
                        <ul data-group="group-56091636512428524071081045549363" className="hlist car_linkage" ><li data-idf="0" data-id="" data-cls="" className="item wid-12"><div className="inner"><div className="hbody" ><p data-pid="0" >A</p></div><div className="hfoot" d><p data-pid="0" data-src="select" data-value="奥迪" >奥迪</p><p data-pid="1" data-src="select" data-value="阿尔法·罗米欧">阿尔法·罗米欧</p><p data-pid="2" data-src="select" data-value="阿斯顿·马丁">阿斯顿·马丁</p><p data-pid="3" data-src="select" data-value="AC Schnitzer" >AC Schnitzer</p></div></div></li></ul>
                        <ul data-group="group-56091636512428524071081045549363" className="hlist car_linkage" ><li data-idf="0" data-id="" data-cls="" className="item wid-12"><div className="inner"><div className="hbody" ><p data-pid="0" >A</p></div><div className="hfoot" d><p data-pid="0" data-src="select" data-value="奥迪" >奥迪</p><p data-pid="1" data-src="select" data-value="阿尔法·罗米欧">阿尔法·罗米欧</p><p data-pid="2" data-src="select" data-value="阿斯顿·马丁">阿斯顿·马丁</p><p data-pid="3" data-src="select" data-value="AC Schnitzer" >AC Schnitzer</p></div></div></li></ul>
                        <ul data-group="group-56091636512428524071081045549363" className="hlist car_linkage" ><li data-idf="0" data-id="" data-cls="" className="item wid-12"><div className="inner"><div className="hbody" ><p data-pid="0" >A</p></div><div className="hfoot" d><p data-pid="0" data-src="select" data-value="奥迪" >奥迪</p><p data-pid="1" data-src="select" data-value="阿尔法·罗米欧">阿尔法·罗米欧</p><p data-pid="2" data-src="select" data-value="阿斯顿·马丁">阿斯顿·马丁</p><p data-pid="3" data-src="select" data-value="AC Schnitzer" >AC Schnitzer</p></div></div></li></ul>
                    </div>
